...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            ...
            "url": "https://github.com/muhammad1505/simdokpol",
            "email": "emailbaruku50@gmail.com"
        },
        "license": {
            "name": "MIT License",
            "url": "https://github.com/muhammad1505/simdokpol/blob/main/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
    ...
    "paths": {
        ...
        "/audit-logs/export": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Error: Gagal membuat file ekspor",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/documents/export": {
            "get": {
                ...
                "description": "Mengunduh daftar dokumen (aktif atau arsip) sebagai file .xlsx. Hanya bisa diakses oleh Super Admin.",
                "produces": [
                    "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                ],
                "tags": [
        ...
        "/documents/{id}/pdf": {
            "get": {
                ...
                "description": "Mengunduh satu surat keterangan hilang sebagai file .pdf yang presisi.",
                "produces": [
                    "application/pdf"
                ],
                "tags": [
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Error: Gagal membuat file PDF",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/setup/restore": {
            "post": {
                "description": "Memulihkan database dari file .db yang diunggah. Hanya bisa diakses saat setup awal.",
                "consumes": [
                    "multipart/form-data"
                ],
                "produces": [
                ...
                "summary": "Pulihkan Database Saat Setup",
                "parameters": [
                    {
                        "type": "file",
                        "description": "File backup .db yang akan di-restore",
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Error: Aplikasi sudah dikonfigurasi",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
